...
# NOTE: This helper function assumes no generator expressions are used for the
# source files
function(target_sources_local target)
  if(POLICY CMP0076)
    # New behavior is available, so just forward to it by ensuring that we have
    # the policy set to request the new behavior, but don't change the policy
    # setting for the calling scope
    cmake_policy(PUSH)
