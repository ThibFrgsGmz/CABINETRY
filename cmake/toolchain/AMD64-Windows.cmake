...
set(CMAKE_C_COMPILER
    "${TOOLCHAIN_PATH}\\clang${TOOLCHAIN_SUFFIX}"
...
set(CMAKE_AR
    "${TOOLCHAIN_PATH}\\llvm-ar${TOOLCHAIN_SUFFIX}"
    CACHE PATH "archiver" FORCE)
set(CMAKE_LINKER
    "${TOOLCHAIN_PATH}\\lld-link${TOOLCHAIN_SUFFIX}"
    CACHE PATH "linker" FORCE)
set(CMAKE_NM
    "${TOOLCHAIN_PATH}\\llvm-nm${TOOLCHAIN_SUFFIX}"
    CACHE PATH "nm" FORCE)
set(CMAKE_OBJCOPY
    "${TOOLCHAIN_PATH}\\llvm-objcopy${TOOLCHAIN_SUFFIX}"
    CACHE PATH "objcopy" FORCE)
set(CMAKE_OBJDUMP
    "${TOOLCHAIN_PATH}\\llvm-objdump${TOOLCHAIN_SUFFIX}"
    CACHE PATH "objdump" FORCE)
set(CMAKE_STRIP
    "${TOOLCHAIN_PATH}\\llvm-strip${TOOLCHAIN_SUFFIX}"
    CACHE PATH "strip" FORCE)
set(CMAKE_SIZE
    "${TOOLCHAIN_PATH}\\llvm-size${TOOLCHAIN_SUFFIX}"
    CACHE PATH "size" FORCE)
set(CMAKE_RANLIB
    "${TOOLCHAIN_PATH}\\llvm-ranlib${TOOLCHAIN_SUFFIX}"
