...
set(DRV_1_LIBRARY_NAMES drv_1 drv_1_1)
if(CMAKE_HOST_SYSTEM MATCHES Linux)
  list(APPEND DRV_1_LIBRARY_NAMES drv_1_2 drv_1_3)
endif()
...
foreach(DRV_1_LIBRARY_NAME ${DRV_1_LIBRARY_NAMES})
  ...
  find_library(
    DRV_1_LIBRARY ${DRV_1_LIBRARY_NAME}
    PATHS ${DRV_1_LIB_PATH}
    PATH_SUFFIXES "lib/${architecture_type}-32" "lib/${architecture_type}-64"
                  "lib/x86-${architecture_type_without_x_prefix}"
...
find_path(
  DRV_1_INCLUDE_DIR "drv-1-api.h"
  PATHS ${DRV_1_LIB_PATH}
  PATH_SUFFIXES "inc/drv-1" "inc")
